    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('age', models.DateField(blank=True, null=True, verbose_name='Год-Месяц-День')),
                ...
                ('male', models.CharField(blank=True, choices=[('Мужчина', 'Мужчина'), ('Женщина', 'Женщина')], default=None, null=True, verbose_name='Пол')),
